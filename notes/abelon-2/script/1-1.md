...
```
???: It's a young girl with fair skin and fiery hair, facedown on the ground. She wears the garb of a hunter, with a bow and quiver slung on her back. She has no visible injuries but appears to be unconscious.
...
-> Callback:
    ...
    ???: The young girl is still alive, but has not moved.
    ...
    *If Abelon has found the camp*
    A: Carry her to camp
        ...
        ???: With effort, you hoist the limp girl and her belongings onto your back. You slowly trudge towards the campsite you found.

        -> Event: Screen fades to black, Elaine and Abelon teleport to camp.
        -> Callback:

            ???: The girl lies on her side, still unconscious. Her breathing is shallow.
```
...
A: Go to sleep
    ...
    // "1-2" appears in the corner of the screen. Script continues 1-2.
...
*If Elaine was not carried to camp*
A: Kill them

    // When this option is selected, a sound effect plays and the music stops.

    // Abelon moves to the side of the camp. As he begins drawing his sword, the screen cuts to black.

    ???: I see... Then I was overly concerned.

    ???: That is a relief.

    // "1-2" appears in the corner of the screen. Script continues 1-5-a.
```